...
import 'package:flutter_design_extension/src/components/multi_selector/bottom_sheet/multi_select_bottom_sheet.dart';
import 'package:flutter_design_extension/src/components/multi_selector/chip_display/multi_select_chip_display.dart';
import 'package:flutter_design_extension/src/components/multi_selector/utils/multi_select_item.dart';
import 'package:flutter_design_extension/src/components/multi_selector/utils/multi_select_list_type.dart';
...
class __MultiSelectBottomSheetFieldViewState<V>
  ...
  Widget _buildInheritedChipDisplay() {
    ...
    chipDisplayItems = _selectedItems.map((e) {
      final index = widget.items.indexWhere((element) => e == element.value);
      if (index >= 0) {
